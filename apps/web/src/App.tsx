    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <header className="border-b border-white/10 bg-slate-950/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div>
            ...
            <h1 className="text-lg font-semibold text-white">Base inicial del frontend</h1>
          </div>
      ...
      <footer className="border-t border-white/10 bg-slate-950/80">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-4 text-sm text-slate-400 md:flex-row md:items-center md:justify-between">
          <span>Interfaz base de la fase 1.2 con rutas, Tailwind y configuración de entorno.</span>
